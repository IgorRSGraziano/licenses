...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference("Parameter.count") do
      post parameters_url, params: { parameter: { description: @parameter.description, identifier: @parameter.identifier, name: @parameter.name } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { description: @parameter.description, identifier: @parameter.identifier, name: @parameter.name } }
